// Demo for a quick texture-wrapped cube
// Has texture atlas wrapping for appearance of multiple textures on one cube
// Most cubes in the game will be rendered like this.
...
gl_FragColor = texture2D(sampler, vUV);\n\
  ...
  /*========================= THE CUBE ========================= */
  //POINTS :
  // Expanded to a texture atlas
  var cube_vertex=[
    // Back
    -.5,-.5,-.5,    4*(1/16),14*(1/16),
    .5,-.5,-.5,     5*(1/16),14*(1/16),
    .5, .5,-.5,     5*(1/16),15*(1/16),
    -.5, .5,-.5,    4*(1/16),15*(1/16),
    ...
    // Top
    -.5,-.5,-.5,    5*(1/16),14*(1/16),
    -.5,-.5, .5,    6*(1/16),14*(1/16),
    .5,-.5, .5,     6*(1/16),15*(1/16),
    .5,-.5,-.5,     5*(1/16),15*(1/16),
  ...
  var cube_texture=get_texture("terrain.png");
